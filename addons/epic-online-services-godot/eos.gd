...
class EUI:
	...
	class UIInterface:
		...
		static func get_notification_location_preference() -> EOS.EUI.NotificationLocation:
			return IEOS.ui_interface_get_notification_location_preference()

		static func get_toggle_friends_key(options: GetToggleFriendsKeyOptions) -> EOS.EUI.KeyCombination:
		...
		static func is_valid_key_combination(key_combination: EOS.EUI.KeyCombination) -> bool:
			return IEOS.ui_interface_is_valid_key_combination(key_combination)

		static func set_display_preference(options: SetDisplayPreferenceOptions) -> EOS.EUI.NotificationLocation:
